...
# 1. [Regular Expression Tutorial](https://github.com/c4arl0s/RegularExpressions#regular-expression)
...
#  * [What Regular Expressions Are Exactly - Terminology](https://github.com/c4arl0s/RegularExpressions#regular-expression)
...
#  * [Different Regular Expression Engines](https://github.com/c4arl0s/RegularExpressions#regular-expression)
...
#  * [Give Regexes a First Try](https://github.com/c4arl0s/RegularExpressions#regular-expression)
...
# 2. [Literal Characters](https://github.com/c4arl0s/RegularExpressions#regular-expression)
...
#  * [Special Characters](https://github.com/c4arl0s/RegularExpressions#regular-expression)
...
#  * [Special Characters and Programming Languages](https://github.com/c4arl0s/RegularExpressions#regular-expression)
...
#  * [Non-Printable Characters](https://github.com/c4arl0s/RegularExpressions#regular-expression)
...
# 3. [First Look at How a Regex Engine Works Internally](https://github.com/c4arl0s/RegularExpressions#regular-expression)
...
#  * [The Regex-Directed Engine Always Returns the Leftmost Match](https://github.com/c4arl0s/RegularExpressions#regular-expression)
...
# 4. [Character Classes or Character Sets](https://github.com/c4arl0s/RegularExpressions#regular-expression)
...
#  * [Useful Applications](https://github.com/c4arl0s/RegularExpressions#regular-expression)
...
#  * [Negated Character Classes](https://github.com/c4arl0s/RegularExpressions#regular-expression)
...
#  * [Metacharacters Inside Character Classes](https://github.com/c4arl0s/RegularExpressions#regular-expression)
...
```console
cat article.txt | grep "\s\s\s\s" | tail -1 | head -1
    * [Looking Inside The Regex Engine]()
```

# 20. [If-Then-Else Conditionals in Regular Expressions]()                                                                                                  # 24. [Free-Spacing Regular Expressions]()
```


#  * [Shorthand Character Classes](https://github.com/c4arl0s/RegularExpressions#regular-expression)
#  * [Negated Shorthand Character Classes](https://github.com/c4arl0s/RegularExpressions#regular-expression)
#  * [Repeating Character Classes](https://github.com/c4arl0s/RegularExpressions#regular-expression)

```console
cat article.txt | grep -E "^[0-9]+\."
```
#  * [Looking Inside The Regex Engine](https://github.com/c4arl0s/RegularExpressions#regular-expression)


# 5. [The Dot Matches (Almost) Any Character ](https://github.com/c4arl0s/RegularExpressions#regular-expression)

# 6. [Start of String and End of String Anchors](https://github.com/c4arl0s/RegularExpressions#regular-expression)
...
# 7. [Word Boundaries](https://github.com/c4arl0s/RegularExpressions#regular-expression)
# 8. [Alternation with The Vertical Bar or Pipe Symbol](https://github.com/c4arl0s/RegularExpressions#regular-expression)
# 9. [Optional Items](https://github.com/c4arl0s/RegularExpressions#regular-expression)
# 10. [Repetition with Star and Plus](https://github.com/c4arl0s/RegularExpressions#regular-expression)
# 11. [Use Round Brackets for Grouping](https://github.com/c4arl0s/RegularExpressions#regular-expression)
# 12. [Named Capturing Groups](https://github.com/c4arl0s/RegularExpressions#regular-expression)
# 13. [Unicode Regular Expressions](https://github.com/c4arl0s/RegularExpressions#regular-expression)
# 14. [Regex Matching Modes](https://github.com/c4arl0s/RegularExpressions#regular-expression)
# 15. [Possessive Quantifiers](https://github.com/c4arl0s/RegularExpressions#regular-expression)
# 16. [Atomic Grouping](https://github.com/c4arl0s/RegularExpressions#regular-expression)
# 17. [Lookahead and Lookbehind Zero-Width Assertions](https://github.com/c4arl0s/RegularExpressions#regular-expression)
# 18. [Testing The Same Part of a String for More Than One Requirement](https://github.com/c4arl0s/RegularExpressions#regular-expression)
# 19. [Continuing at The End of The Previous Match](https://github.com/c4arl0s/RegularExpressions#regular-expression)
# 20. [If-Then-Else Conditionals in Regular Expressions](https://github.com/c4arl0s/RegularExpressions#regular-expression)
# 21. [XML Schema Character Classes ](https://github.com/c4arl0s/RegularExpressions#regular-expression)
# 22. [POSIX Bracket Expressions](https://github.com/c4arl0s/RegularExpressions#regular-expression)
# 23. [Adding Comments to Regular Expressions](https://github.com/c4arl0s/RegularExpressions#regular-expression)
# 24. [Free-Spacing Regular Expressions](https://github.com/c4arl0s/RegularExpressions#regular-expression)
# 
# Examples
# 
# 1. [Sample Regular Expression](https://github.com/c4arl0s/RegularExpressions#regular-expression)
# 2. [Matching Floating Point Numbers with a Regular Expression](https://github.com/c4arl0s/RegularExpressions#regular-expression)
# 3. [How to Find or Validate an Email Address](https://github.com/c4arl0s/RegularExpressions#regular-expression)
# 4. [Matching a Valid Date](https://github.com/c4arl0s/RegularExpressions#regular-expression)
# 5. [Matching Whole Lines of Text](https://github.com/c4arl0s/RegularExpressions#regular-expression)
# 6. [Deleting Duplicate Lines From a File ](https://github.com/c4arl0s/RegularExpressions#regular-expression)
# 8. [Find Two Words Near Each Other](https://github.com/c4arl0s/RegularExpressions#regular-expression)
# 9. [Runaway Regular Expressions: Catastrophic Backtracking](https://github.com/c4arl0s/RegularExpressions#regular-expression)
# 10. [Repeating a Capturing Group vs. Capturing a Repeated Group](https://github.com/c4arl0s/RegularExpressions#regular-expression)
